    ...
    <div class="main_left">
        ...
        <?php
			...
			<?php	if(isset($_POST['kh_capnhat'])){ ?>
				<table>
                <th colspan="4" style="text-align: center; padding-bottom: 10px; color:  #0F77EC; font-size: 50px;">THÔNG TIN CÁ NHÂN</th>
						<?php 
			...
			<br>
				...
				<?php } }else{?>
			    <a href="TMDT\login\formdangnhap.php"><b style="color: #079D49;">VUI LÒNG ĐĂNG NHẬP</a></b>
				<?php }
				?>

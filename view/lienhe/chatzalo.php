<?php 
        $SDT = "SELECT TV_SDT FROM THANHVIEN
                WHERE TV_MA = '".$_GET['matrang']."'";
        $qr = mysqli_query($mysqli, $SDT);
        $n = mysqli_fetch_array($qr);
    ?>
<a href="https://chat.zalo.me/?phone=<?php echo $n['TV_SDT']; ?>" id="linkzalo" target="_blank" rel="noopener noreferrer">
    <div id="fcta-zalo-tracking" class="fcta-zalo-mess">
        <span id="fcta-zalo-tracking">Chat người bán</span></div>
...
<script>
        ...
        document.getElementById("linkzalo").href = "https://zalo.me/<?php echo $n['TV_SDT']; ?>";
    }
</script>